...
and serves as the working template for Quarto Manual authors. Write for a
...
block or several. Each procedure changes project or system state and should make
the operator's inputs, consequential choices, and expected resulting artifact
visible. Avoid tutorial exposition by default.
