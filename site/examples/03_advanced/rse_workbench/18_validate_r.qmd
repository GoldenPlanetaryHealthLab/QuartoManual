---
title: "Validate R From Spack"
format: html
execute:
  eval: false
---

::: {.manual-prereq title="Confirm The Spack Layer"}

Confirm that the Spack installation completed before validating R.
...
:::: {.manual-procedure title="Validate R From Spack"}
...
::: {.manual-check title="Verify R Runtime"}

Confirm that `R`, `Rscript`, and the required image capabilities are reported
